...
const PatientTable = () => {
    ...
    const handleApprove = (id: number) => {
        ...
        handleStatusUpdate(id, 'معتمد');
    };

    const handleReject = (id: number) => {
        // Implement the reject functionality
        handleStatusUpdate(id, 'مرفوض');
    };
                ...
                <tbody>
                    {filteredRequests.map((request, index) => (
                        ...
                        >
                            ...
                            <td style={styles.td}>
                                <Button variant="outline-primary" size="sm" style={styles.actionButton} onClick={() => handleApprove(request.id)}>
